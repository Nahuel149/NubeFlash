<?php $this->view('frontend/email/_header', array()); // Header has hardcoded background now ?>
                            ...
                            <tr>
                                <td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="flexibleContainer">
                                        <tr>
                                            <td>
                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:20px;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;">
                                                    <span><?php echo $dato['name']; ?>, Bienvenido(a) a "Nube Flash"</span><br>
                                                    <span>Se registró con los siguientes datos:</span><br>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
