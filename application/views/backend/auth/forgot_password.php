...
<head>
    ...
    <title>Recuperar Contraseña - La Nube</title>
...
<body>
    ...
    <div class="auth-box-w">
        ...
        <div class="auth-header">
            Por favor ingresa tu correo electrónico para recibir las instrucciones de recuperación de contraseña.
        </div>
        ...
        <?php echo form_open("backend/auth/forgot_password"); ?>
            ...
            <div class="buttons-w">
                ...
                <a href="<?php echo base_url('backend/auth/login'); ?>" class="btn btn-default">Cancelar</a>
            </div>
        <?php echo form_close(); ?>

        <div class="back-link">
            <a href="<?php echo base_url('backend/auth/login'); ?>">
